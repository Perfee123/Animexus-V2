      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2 space-y-6">
            ...
            <p className="text-muted-foreground text-sm max-w-xs leading-relaxed">
              Your ultimate nexus for anime discovery. Explore trending titles,
              track your favorites, and dive deep into character insights.
            </p>
            <div className="flex items-center gap-4">
              <a
                href="https://github.com/Perfee123"
                target="_blank"
                className="p-2 rounded-full bg-white/5 border border-white/10 text-muted-foreground hover:text-primary hover:border-primary transition-all">
                <Github size={20} />
              </a>

              <a
                href="https://x.com/PERFEE123"
                target="_blank"
                className="p-2 rounded-full bg-white/5 border border-white/10 text-muted-foreground hover:text-primary hover:border-primary transition-all">
                <Twitter size={20} />
              </a>
        ...
        <div className="mt-12 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <Link
              href="/privacy"
              className="text-muted-foreground text-[10px] hover:text-white transition-colors">
              PRIVACY POLICY
            </Link>
            <Link
              href="/terms"
