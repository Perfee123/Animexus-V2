                ...
                >
                  <div className="flex flex-col">
                    ...
                    <div className="flex items-center gap-3">
                      <Star className="h-6 w-6 text-primary fill-primary shadow-[0_0_15px_rgba(59,130,246,0.5)]" />
                      ...
                      <div className="space-y-8">
                        ...
                        <div className="grid sm:grid-cols-2 gap-4">
                          {mangaAdaptation.map((entry: any) => (
                            <div key={entry.mal_id} className="p-6 rounded-[2rem] bg-white/5 border border-white/10 flex items-center justify-between group hover:border-primary/50 transition-all">
                        ...
                        <div key={i} className="p-8 rounded-[2.5rem] bg-white/5 border border-white/10 space-y-4 hover:border-primary/30 transition-all">
                          ...
                          <div className="space-y-3">
                            {rel.entry.map((entry: any) => (
                              <div key={entry.mal_id} className="flex items-center justify-between text-white font-bold group cursor-pointer">
